...
public class InformationActivity extends BaseActivity {
    ...
    private void displayDebugInfo() {
        ...
        this.addDebugRow(table, "REG ID", Utils.INSTANCE.getInternalSettingString(this, Const.GCM_REG_ID, ""));
        this.addDebugRow(table, "REG Transmission", DateUtils.getRelativeDateTimeString(this, Utils.INSTANCE.getInternalSettingLong(this, Const.GCM_REG_ID_LAST_TRANSMISSION, 0),
